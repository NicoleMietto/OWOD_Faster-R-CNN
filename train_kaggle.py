...
def main():
    ...
    print(f"Starting training on Kaggle: {device}")
    ...
    # ==========================================
    # 3. Dataset Setup (Task 1 su Kaggle)
    # ==========================================
    ...
    # BATCH SIZE 4 come richiesto per Kaggle
    ...
    # Percorsi per Kaggle
    checkpoint_path = "/kaggle/working/kaggle_owod_model_last.pth"
    csv_file = "/kaggle/working/kaggle_training_metrics.csv"
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        epoch_path = f"/kaggle/working/kaggle_owod_model_epoch_{epoch+1}.pth"
        ...
        if val_avg['total'] < best_val_loss:
            ...
            torch.save(model.state_dict(), "/kaggle/working/kaggle_best_model.pth")
        else:
            patience_counter += 1
