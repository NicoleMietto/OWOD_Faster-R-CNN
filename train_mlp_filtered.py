...
from OWOD_detector_mlp_filtered import OWODFasterRCNN_Fixed # IMPORTIAMO IL MODELLO AGGIORNATO E FILTRATO
...
def main():
    ...
    if args.resume and os.path.exists(args.resume):
        ...
        # Filtro vitale per gestire l'aggiunta della nuova classe 11 nel classificatore
        ...
        for k, v in state_dict_to_load.items():
            if k in model_dict:
                if v.shape == model_dict[k].shape:
                    ...
                    print(f"Ignoro i pesi di {k} perché la dimensione è cambiata (es. nodo output aggiunto).")
    ...
    csv_file = "/kaggle/working/training_metrics_fixed.csv"
    ...
    for epoch in range(args.start_epoch, args.start_epoch + args.epochs):
        ...
        epoch_path = f"/kaggle/working/owod_model_epoch_{epoch+1}_fixed.pth"
        ...
        if save_best and val_avg['total'] < best_val_loss:
            ...
            best_path = "/kaggle/working/best_model_fixed.pth"
